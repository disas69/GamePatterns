...
{
    GameStateMachine.AddTransition(EGameState::None, EGameState::MainMenu, [this]()
    {
        UE_LOG(LogTemp, Warning, TEXT("Opening menu"));
        OnOpenMenu();
    });
    
    GameStateMachine.AddTransition(EGameState::MainMenu, EGameState::InGame, [this]()
    {
        UE_LOG(LogTemp, Warning, TEXT("Starting game"));
        OnStartGame();
    });
    
    GameStateMachine.AddTransition(EGameState::InGame, EGameState::GameOver, [this]()
    {
